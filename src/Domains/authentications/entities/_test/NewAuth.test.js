...
describe('NewAuth entities', () => {
  it('should throw error when payload not contain needed property', () => {
    ...
    // Action & Assert
    expect(() => new NewAuth(payload)).toThrowError('REGISTER_USER.NOT_CONTAIN_NEEDED_PROPERTY');
  });
  ...
  it('should throw error when payload not meet data type specification', () => {
    ...
    // Action & Assert
    expect(() => new NewAuth(payload)).toThrowError('REGISTER_USER.NOT_MEET_DATA_TYPE_SPECIFICATION');
  });
