...
describe('a PutLike entities', () => {
  it('should throw error when payload did not contain needed property', () => {
    ...
    // Action and Assert
    expect(() => new PutLike(payload)).toThrowError('PUT_LIKE.NOT_CONTAIN_NEEDED_PROPERTY');
  });
  ...
  it('should throw error when payload did not meet data type specification', () => {
    ...
    // Action and Assert
    expect(() => new PutLike(payload)).toThrowError('PUT_LIKE.NOT_MEET_DATA_TYPE_SPECIFICATION');
  });
